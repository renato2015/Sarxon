 ...
 */
public class captura extends JFrame implements  Runnable, WebcamListener, WindowListener, UncaughtExceptionHandler, ItemListener, WebcamDiscoveryListener, PropertyChangeListener
{
    static
    {
    ...
    public void run ()
    {
        ...
        btnGravarVideo.addActionListener(new ActionListener()
        {
            ...
            public void actionPerformed (ActionEvent ae)
            {
                try
                {
                    ...
                    Dimension size = com.github.sarxos.webcam.WebcamResolution.SXGA.getSize();
        ...
        Dimension d = WebcamResolution.VGA.getSize();
        webcam.setViewSize(d);

//        JOptionPane.showMessageDialog(null, WebcamResolution.VGA.getSize());
        webcam.addWebcamListener(captura.this);
...
//        panel.setFPSDisplayed(true);
    ...
    {
        SwingUtilities.invokeLater(new captura());
    }
    ...
    public void itemStateChanged (ItemEvent e)
    {
        if (e.getItem() != webcam)
        {
            if (webcam != null)
            {
                ...
                System.out.println("Dispositivo de captura selecionado: " + webcam.getName());
    ...
    private void abrirControleImagem ()
    {
